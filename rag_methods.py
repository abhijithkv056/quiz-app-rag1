...
def get_conversational_rag_chain(llm):
    ...
    prompt = ChatPromptTemplate.from_messages([
        ("system",
        """You are a quiz master that ask questions to user. you will ask user a question and give 4 options..make sure all 4 options are shown in separate. only one opion will be correct.
